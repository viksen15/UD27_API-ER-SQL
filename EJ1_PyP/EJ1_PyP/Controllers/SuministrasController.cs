...
namespace EJ1_PyP.Controllers
{
    ...
    public class SuministrasController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Suministra>> GetSuministra(char? id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutSuministra(char? id, Suministra suministra)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<Suministra>> DeleteSuministra(char? id)
        {
            var suministra = await _context.Suministra.FindAsync(id);
            if (suministra == null)
            {
        ...
        private bool SuministraExists(char? id)
        {
