...
namespace EJ1_PyP.Controllers
{
    ...
    public class ProveedoresController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Proveedores>> GetProveedores(char? id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutProveedores(char? id, Proveedores proveedores)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<Proveedores>> DeleteProveedores(char? id)
        {
            var proveedores = await _context.Proveedores.FindAsync(id);
            if (proveedores == null)
            {
        ...
        private bool ProveedoresExists(char? id)
        {
